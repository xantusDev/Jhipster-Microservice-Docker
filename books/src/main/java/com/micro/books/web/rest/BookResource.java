...
import com.micro.books.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.micro.books.domain.Book}.
 */
@RestController
@RequestMapping("/api")
public class BookResource {
    ...
    private static final String ENTITY_NAME = "booksBook";
